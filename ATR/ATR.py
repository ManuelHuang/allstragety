...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self,period_atr = 2220,period_sma = 2220,b = 2,backup_percentage = 0.01,trail_percentage = 0.04,back_stop_order_percentage = 1.04):
        ...
        self.back_stop_order_percentage_sell = 1.04  # 测试范围 1.005-1.02，步长0.001
        self.back_stop_order_percentage_buy = 1.04
        self.is_print = True

...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self,trail_percentage=0.05,back_stop_order_percentage=1.03,devfactors=3,periods=1800):
        ...
        self.bolling = bt.indicators.BBands(period = periods, devfactor = devfactors) #period测试范围 1440-2880 步长120  devfactor 测试范围 3-7 步长0.5
    ...
    def next(self):
        ...
        if self.position.size == 0 and self.datas[0].datetime.time().minute == 00 and len(self) > self.periods:

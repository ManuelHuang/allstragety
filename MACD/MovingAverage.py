...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self,period = 60,period_sell = 60,b = 2.5,b_sell = 2.5,trail_percentage = 0.05,trail_percentage_sell = 0.05,back_stop_order_percentage = 1.03,back_stop_order_percentage_sell = 1.03):

...
class TestStrategy(bt.Strategy):
    ...
    def __init__(self,period_me1_buy=120,period_me1_sell=120,period_me2_buy=180,period_me2_sell=180,period_signal_buy=60,period_signal_sell=60,period_sleep_buy= 120,period_sleep_sell= 120,back_stop_order_percentage_buy = 1.03,back_stop_order_percentage_sell = 1.03):
